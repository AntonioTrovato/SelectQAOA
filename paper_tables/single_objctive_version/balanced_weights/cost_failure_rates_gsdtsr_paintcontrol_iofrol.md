...
|---|---|----------------:|--------------------:|-------------------------:|------------------:|-----------------------:|
| *GSDTSR* | QAOA-TCS | Ideal simulator |         9203483.921 |                       -- |         **8.039** |                     -- |
...
| *PaintControl* | QAOA-TCS | Ideal simulator |          517373.000 |                       -- |             9.876 |                     -- |
...
| *IOF/ROL* | QAOA-TCS | Ideal simulator |    **38965151.000** |                       -- |       **329.133** |                     -- |
