...
| `selectqa` vs `qaoa_fake_brisbane` | 2.028356e-09 | 7.302080e-08 | 0.00 |
...
| `div_ga` vs `qaoa_fake_brisbane` | 7.281303e-12 | 2.621269e-10 | 1.00 |
...
| `add_greedy` vs `qaoa_fake_brisbane` | 8.829880e-02 | 1.000000e+00 | 0.00 |
...
| `qaoa_statevector_sim` vs `qaoa_fake_brisbane` | 8.366954e-04 | 3.012103e-02 | 0.00 |
...
| `qaoa_aer_sim` vs `qaoa_fake_brisbane` | 1.847934e-05 | 6.652561e-04 | 0.00 |
...
| `qaoa_fake_brisbane` vs `qaoa_depolarizing_1` | 1.726206e-02 | 6.214343e-01 | 1.00 |
| `qaoa_fake_brisbane` vs `qaoa_depolarizing_2` | 2.761794e-07 | 9.942460e-06 | 1.00 |
| `qaoa_fake_brisbane` vs `qaoa_depolarizing_5` | 2.546411e-01 | 1.000000e+00 | 1.00 |
...
| `selectqa` vs `qaoa_fake_brisbane` | 8.671150e-02 | 1.000000e+00 | 1.00 |
...
| `div_ga` vs `qaoa_fake_brisbane` | 7.533577e-03 | 2.712088e-01 | 1.00 |
...
| `add_greedy` vs `qaoa_fake_brisbane` | 2.712062e-02 | 9.763424e-01 | 0.00 |
...
| `qaoa_statevector_sim` vs `qaoa_fake_brisbane` | 3.156929e-02 | 1.000000e+00 | 0.00 |
...
| `qaoa_aer_sim` vs `qaoa_fake_brisbane` | 8.898120e-04 | 3.203323e-02 | 0.00 |
...
| `qaoa_fake_brisbane` vs `qaoa_depolarizing_1` | 2.921126e-01 | 1.000000e+00 | 1.00 |
| `qaoa_fake_brisbane` vs `qaoa_depolarizing_2` | 3.917197e-01 | 1.000000e+00 | 1.00 |
| `qaoa_fake_brisbane` vs `qaoa_depolarizing_5` | 1.621949e-03 | 5.839017e-02 | 1.00 |
...
| `selectqa` vs `qaoa_fake_brisbane` | 2.377678e-11 | 8.559640e-10 | 0.00 |
...
| `div_ga` vs `qaoa_fake_brisbane` | 5.738021e-09 | 2.065687e-07 | 0.00 |
...
| `add_greedy` vs `qaoa_fake_brisbane` | 8.338952e-03 | 3.002023e-01 | 0.00 |
...
| `qaoa_statevector_sim` vs `qaoa_fake_brisbane` | 6.522986e-04 | 2.348275e-02 | 0.00 |
...
| `qaoa_aer_sim` vs `qaoa_fake_brisbane` | 6.774593e-07 | 2.438854e-05 | 0.00 |
...
| `qaoa_fake_brisbane` vs `qaoa_depolarizing_1` | 2.384117e-04 | 8.582820e-03 | 1.00 |
| `qaoa_fake_brisbane` vs `qaoa_depolarizing_2` | 6.073207e-01 | 1.000000e+00 | 1.00 |
| `qaoa_fake_brisbane` vs `qaoa_depolarizing_5` | 1.130731e-01 | 1.000000e+00 | 1.00 |
...
| `selectqa` vs `qaoa_fake_brisbane` | 9.453491e-03 | 3.403257e-01 | 0.00 |
...
| `add_greedy` vs `qaoa_fake_brisbane` | 2.122306e-02 | 7.640301e-01 | 0.00 |
...
| `qaoa_statevector_sim` vs `qaoa_fake_brisbane` | 1.759680e-01 | 1.000000e+00 | 0.00 |
...
| `qaoa_aer_sim` vs `qaoa_fake_brisbane` | 8.208741e-02 | 1.000000e+00 | 0.00 |
...
| `qaoa_fake_brisbane` vs `qaoa_depolarizing_1` | 1.526138e-01 | 1.000000e+00 | 1.00 |
| `qaoa_fake_brisbane` vs `qaoa_depolarizing_2` | 3.776698e-01 | 1.000000e+00 | 1.00 |
| `qaoa_fake_brisbane` vs `qaoa_depolarizing_5` | 8.112544e-04 | 2.920516e-02 | 1.00 |
